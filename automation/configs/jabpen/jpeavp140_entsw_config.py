...
import apollo.config.common.c4k.c4k_common_stations as c4k_common_stations


__version__ = "0.2.0"
__title__ = "Enterprise Switching C9400 Config for JPE Production"
__author__ = ['bborel', 'rluktong', 'gchew']
...
#
#
# REMOVE AFTER NEW COMMON METHOD IS CONFIRMED
#
#
#
...
def uabu_c4k_linecard_config_OBSOLETE():
    """ Macallan
