"""
PRODUCT DEFINITIONS for C3K Euclid
...
__title__ = "C3K Euclid Product Definitions"
__version__ = '0.2.0'
__family__ = "euclid"
__consumer__ = 'c3650.Euclid'


family = {
    'COMMON': {
        'product_family': "euclid",
    ...
    'EUCLID24Q': {
        'cfg_pids': ['WS-C3650-8X24UQ-L', 'WS-C3650-8X24UQ-E', 'WS-C3650-8X24UQ-S'],
        'MODEL_NUM': 'WS-C3850-8X24UQ',
        'MODEL_REVISION_NUM': '',
        'TAN_NUM': '68-100507-01',
        'TAN_REVISION_NUMBER': '',
        'MOTHERBOARD_ASSEMBLY_NUM': '73-100819-01',
        ...
        'eco_manifest': {('68-100507-02E0', 'FTX'): (None, 'EA555740', ['SYSFT'], ''),
                         ('68-100507-02D0', 'FTX'): (None, 'EA555740', ['SYSFT'], ''),
                         ('68-100507-02C0', 'FTX'): (None, '90021', ['SYSFT'], ''),
                         ('68-100507-02B0', 'FTX'): (None, '87152', ['SYSFT'], ''),
                         ('68-100507-01A0', 'FTX'): (None, 'EA536295', ['SYSFT'], ''),
                         ('68-100507-02A0', 'FTX'): (None, '78703', ['SYSFT'], ''),
                         ('68-100507-01B0', 'FTX'): (None, '83581', ['SYSFT'], ''),
                         },
    },

    'EUCLID24D': {
        'cfg_pids': ['WS-C3650-8X24PD-L', 'WS-C3650-8X24PD-E', 'WS-C3650-8X24PD-S'],
        'MODEL_NUM': 'WS-C3850-8X24PD',
        'MODEL_REVISION_NUM': '',
        'TAN_NUM': '68-100970-01',
        'TAN_REVISION_NUMBER': '',
        'MOTHERBOARD_ASSEMBLY_NUM': '73-101085-01',
        'MOTHERBOARD_REVISION_NUM': '',
        'POE1_SERIAL_NUM': '',
        'POE1_ASSEMBLY_NUM': '',
        'POE1_REVISION_NUM': '',
        ...
        'cmpd_types': ('cmpd_type_verify_manifest', ['P.24.1', 'P.24.2', 'P.24.3']),
        'eco_manifest': {('68-100970-02F0', 'FTX'): (None, 'EA556109', ['SYSFT'], ''),
                         ('68-100970-02C0', 'FTX'): (None, '87546', ['SYSFT'], ''),
                         ('68-100970-02A0', 'FTX'): (None, '87051', ['SYSFT'], ''),
                         ('68-100970-01A0', 'FTX'): (None, 'EA540909', ['SYSFT'], ''),
                         ('68-100970-01B0', 'FTX'): (None, 'EA540909', ['SYSFT'], ''),
                         }
    },

    'EUCLID48Q': {
        'cfg_pids': ['WS-C3650-12X48UQ-L', 'WS-C3650-12X48UQ-E', 'WS-C3650-12X48UQ-S'],
        'MODEL_NUM': 'WS-C3850-12X48UQ',
        'MODEL_REVISION_NUM': '',
        'TAN_NUM': '68-100537-01',
        'TAN_REVISION_NUMBER': '',
        'MOTHERBOARD_ASSEMBLY_NUM': '73-100875-01',
        'MOTHERBOARD_REVISION_NUM': '',
        'POE1_SERIAL_NUM': '',
        'POE1_ASSEMBLY_NUM': '',
        'POE1_REVISION_NUM': '',
        ...
        'eco_manifest': {('68-100537-02D0', 'FTX'): (None, '91649', ['SYSFT'], ''),
                         ('68-100537-02C0', 'FTX'): (None, '90070', ['SYSFT'], ''),
                         ('68-100537-02A0', 'FTX'): (None, 'E84484', ['SYSFT'], ''),
                         ('68-100537-02B0', 'FTX'): (None, '84482', ['SYSFT'], ''),
                         ('68-100537-01A0', 'FTX'): (None, '83244', ['SYSFT'], ''),
                         ('68-100537-01B0', 'FTX'): (None, '78702', ['SYSFT'], ''),
                         }
    },

    'EUCLID48D': {
        'cfg_pids': ['WS-C3650-12X48FD-L', 'WS-C3650-12X48FD-E', 'WS-C3650-12X48FD-S'],
        'MODEL_NUM': 'WS-C3850-12X48FD',
        'MODEL_REVISION_NUM': '',
        'TAN_NUM': '68-100969-01',
        'TAN_REVISION_NUMBER': '',
        'MOTHERBOARD_ASSEMBLY_NUM': '73-101086-01',
        'MOTHERBOARD_REVISION_NUM': '',
        'POE1_SERIAL_NUM': '',
        'POE1_ASSEMBLY_NUM': '',
        'POE1_REVISION_NUM': '',
        ...
        'cmpd_types': ('cmpd_type_verify_manifest', ['P.48.1', 'P.48.2', 'P.48.3']),
        'eco_manifest': {('68-100969-02E0', 'FTX'): (None, 'EA556109', ['SYSFT'], ''),
                         ('68-100969-02D0', 'FTX'): (None, '91441', ['SYSFT'], ''),
                         ('68-100969-02C0', 'FTX'): (None, '90181', ['SYSFT'], ''),
                         ('68-100969-02B0', 'FTX'): (None, '87265', ['SYSFT'], ''),
                         ('68-100969-02A0', 'FTX'): (None, 'EA540905', ['SYSFT'], ''),
                         ('68-100969-01B0', 'FTX'): (None, 'EA540909', ['SYSFT'], ''),
                         ('68-100969-01A0', 'FTX'): (None, 'EA540909', ['SYSFT'], ''),
                         }
    },

    'EUCLID48R': {
        'cfg_pids': ['WS-C3650-12X48UR-L', 'WS-C3650-12X48UR-E', 'WS-C3650-12X48UR-S'],
        'MODEL_NUM': 'WS-C3850-12X48UR',
        'MODEL_REVISION_NUM': '',
        'TAN_NUM': '68-100508-01',
        'TAN_REVISION_NUMBER': '',
        'MOTHERBOARD_ASSEMBLY_NUM': '73-100818-01',
        'MOTHERBOARD_REVISION_NUM': '',
        'POE1_SERIAL_NUM': '',
        'POE1_ASSEMBLY_NUM': '',
        'POE1_REVISION_NUM': '',
        ...
        'cmpd_types': ('cmpd_type_verify_manifest', ['P.48.1', 'P.48.2', 'P.48.3']),
        'eco_manifest': {('68-100508-02D0', 'FTX'): (None, 'EA555740', ['SYSFT'], ''),
                         ('68-100508-02C0', 'FTX'): (None, '90208', ['SYSFT'], ''),
                         ('68-100508-02B0', 'FTX'): (None, 'EA536296', ['SYSFT'], ''),
                         ('68-100508-02A0', 'FTX'): (None, 'EA536296', ['SYSFT'], ''),
                         ('68-100508-01A0', 'FTX'): (None, 'EA536295', ['SYSFT'], ''),
                         ('68-100508-01B0', 'FTX'): (None, '79255', ['SYSFT'], ''),
                         }
    },

    'EUCLID48Z': {
        'cfg_pids': ['WS-C3650-12X48UZ-L', 'WS-C3650-12X48UZ-E', 'WS-C3650-12X48UZ-S'],
        'MODEL_NUM': 'WS-C3850-12X48UZ',
        'MODEL_REVISION_NUM': '',
        'TAN_NUM': '68-100509-01',
        'TAN_REVISION_NUMBER': '',
        'MOTHERBOARD_ASSEMBLY_NUM': '73-100820-01',
        'MOTHERBOARD_REVISION_NUM': '',
        'POE1_SERIAL_NUM': '',
        'POE1_ASSEMBLY_NUM': '',
        'POE1_REVISION_NUM': '',
        ...
        'cmpd_types': ('cmpd_type_verify_manifest', ['P.48.1', 'P.48.2', 'P.48.3']),
        'eco_manifest': {('68-100509-02B0', 'FTX'): (None, 'EA554328', ['SYSFT'], ''),
                         ('68-100509-02C0', 'FTX'): (None, 'EA554328', ['SYSFT'], ''),
                         ('68-100509-02A0', 'FTX'): (None, '87685', ['SYSFT'], ''),
                         ('68-100509-01A0', 'FTX'): (None, 'EA536295', ['SYSFT'], ''),
                         ('68-100509-01B0', 'FTX'): (None, '79256', ['SYSFT'], ''),
                         }
    },
