...
__title__ = "Archimedes Steps Module"
__version__ = '2.0.0'
__author__ = ['bborel']
...
def get_mode():
    ...
    return aplib.PASS if a.mode_mgr.current_mode else (aplib.FAIL, 'Cannot get mode.')
...
def goto_mode(mode, **kwargs):
    ...
    """
    return aplib.PASS if a.mode_mgr.goto_mode(mode, **kwargs) else (aplib.FAIL, 'Cannot go to mode: {0}'.format(mode))
...
def peripheral_manual_select(**kwargs):
    ...
    return a.peripheral.manual_select(**kwargs)
...
def linux_set_network_interface(**kwargs):
    ...
    return a.linux.set_network_interface(**kwargs)
...
def pcamap_read_uut(**kwargs):
    ...
    return a.pcamap.read_uut(**kwargs)
...
def traffic_fmdiags_traffic_test(**kwargs):
    ...
    return a.traffic.fmdiags.traffic_test(**kwargs)
