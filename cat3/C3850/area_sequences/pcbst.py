...
SEQ_STEP_MAP = {
    'EDISON': SeqStep(steps_edison, 'edison_sequence'),
}
...
# EDISON
#-----------------------------------------------------------------------------------------------------------------------
def edison_sequence(seq, pf, udd, container):
    """ Nyquist SEQ
    :param seq:
    :param pf:
    :param udd:
    ...
    seq.add_step(steps_edison.process_register_genealogy,
    ...
    # ------------------------------------------------------------------------------------------------------------------
    # Power ON & Boot
    seq.add_step(steps_edison.power_cycle_on, name='POWER ON BOOT', kwargs={}, group_level=5)
