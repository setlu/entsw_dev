...
def ud_print_uut_descriptor():
    return e.ud.print_uut_descriptor()

def ud_print_product_manifest():
    return e.ud.print_product_manifest()

def ud_print_uut_config():
    return e.ud.print_uut_config()

def ud_retrieve():
    return e.ud.retrieve()

def get_mode():
    """:menu: (enable=True, name=GET MODE,   section=Mode, num=00, args={})"""
    return aplib.PASS if e.mode_mgr.current_mode else (aplib.FAIL, 'Cannot get mode.')
...
def goto_mode(mode, **kwargs):
    ...
    """
    return aplib.PASS if e.mode_mgr.goto_mode(mode, **kwargs) else (aplib.FAIL, 'Cannot go to mode: {0}'.format(mode))
...
def peripheral_manual_select(**kwargs):
    ...
    return e.peripheral.manual_select(**kwargs)
...
def linux_set_network_interface(**kwargs):
    ...
    return e.linux.set_network_interface(**kwargs)
...
def linux_tftp(**kwargs):
    ...
    return e.linux.tftp(**kwargs)

def linux_set_terminal_width(**kwargs):
    return e.linux.set_termial_width(**kwargs)
...
def pcamap_read_uut(**kwargs):
    ...
    return e.pcamap.read_uut(**kwargs)
...
def act2_sign_chip(**kwargs):
    ...
    return e.act2.sign_chip(**kwargs)

def act2_authenticate(**kwargs):
    """:menu: (enable=True, name=ACT2 AUTH, section=IdPro, num=2.1, args={'menu': True})"""
    return e.act2.authenticate(**kwargs)

def quack2_authenticate(**kwargs):
    """:menu: (enable=True, name=QUACK AUTH, section=IdPro, num=2.2, args={'menu': True})"""
    return e.quack2.authenticate(**kwargs)

def x509sudi_sign_certificate(**kwargs):
    """:menu: (enable=True, name=X509 SUDI, section=IdPro, num=3, args={'menu': True})"""
    return e.x509sudi.sign_certificate(**kwargs)

def quack2_sign_chip(**kwargs):
    return e.quack2.sign_chip(**kwargs)
...
def traffic_fmdiags_traffic_test(**kwargs):
    ...
    return e.traffic.fmdiags.traffic_test(**kwargs)
