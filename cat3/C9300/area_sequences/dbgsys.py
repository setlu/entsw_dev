...
SEQ_STEP_MAP = {
    ...
    'ARCADE': SeqStep(steps_nyquist, 'arcade_sequence'),
}
...
# NYQUIST
#-----------------------------------------------------------------------------------------------------------------------
def nyquist_sequence(seq, pf, udd):
    subseq__init(seq, pf)
    seq.add_step(steps_nyquist.debug_menu, name="MENU", kwargs={})
    seq.add_step(steps_nyquist.final, name='FINAL')
    return seq
...
# ARCADE
#-----------------------------------------------------------------------------------------------------------------------
def arcade_sequence(seq, pf, udd):
    subseq__init(seq, pf)
    seq.add_step(steps_arcade.debug_menu, name="MENU", kwargs={})
    seq.add_step(steps_arcade.final, name='FINAL')
    return seq
