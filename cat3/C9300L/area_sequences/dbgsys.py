...
def franklin_sequence(seq, pf, udd):
    subseq__init(seq, pf)
    seq.add_step(steps_franklin.debug_menu, name="MENU", kwargs={})
    seq.add_step(steps_franklin.final, name='FINAL')
    return seq
...
def newfamily_sequence(seq, pf, udd):
    subseq__init(seq, pf)
    seq.add_step(steps_newfamily.debug_menu, name="MENU", kwargs={})
    seq.add_step(steps_newfamily.final, name='FINAL')
    return seq
