"""
PRODUCT LINE DEFINITIONS for ALL C9300L Products
...
__title__ = "C9300L Product Line Definitions"
__version__ = '2.0.0'
__line__ = 'C9300L'
__category__ = 'SWITCH'

# C9300L UUT modes and their associated prompts
...
uut_prompt_map = [
    ('BTLDRG', 'switch:', ('version', '[Gg]olden')),
...
#
#
# Sample TLV Filed Types supported
# """
#   CLEI codes                       |    0xC6
#   Controller Type                  |    0x40
#   DB info                          |    0xE6
#   Deviation Number                 |    0x88
#   ECI number - Alphanumeric        |    0xEB
#   ECI number - Number              |    0x8E
#   ENVMON info                      |    0xC7
#   Field Diagnostic info            |    0xC5
#   Hardware Version <major.minor>   |    0x41
#   MAC address - Base               |    0xCF
#   MAC address - block size         |    0x43
#   MAC address - chassis            |    0xC3
#   Manufacturing test data          |    0xC4
#   Part Number - PCA(4-byte)        |    0x82
#   Part Number - PCA(6-byte)        |    0xE2
#   Part Number - TAN(4-byte)        |    0x87
#   Part Number - TAN(5-byte)        |    0xDF
#   Part Number - TAN(6-byte)        |    0xC0
#   PCB Fab Version                  |    0x02
#   Platform features                |    0xC9
#   Power consumption                |    0xF3
#   Power Supply Type                |    0x0B
#   Product number/identifier        |    0xCB
#   Revision number - PCA            |    0x42
#   Revision number - TAN            |    0x8D
#   RFID - chassis                   |    0xE4
#   RFID - PCA                       |    0xE5
#   RMA history                      |    0x04
#   RMA Number                       |    0x81
#   RMA test history                 |    0x03
#   Serial number                    |    0xC2
#   Serial Number - PCA              |    0xC1
#   UID name/Base PID                |    0xDB
#   Version identifier               |    0x89
# """
tlv_map_list = [
    ('Part Number - PCA(4-byte)',      ('0x82', 'MOTHERBOARD_ASSEMBLY_NUM')),
    ('Part Number - PCA(6-byte)',      ('0xE2', 'MOTHERBOARD_ASSEMBLY_NUM')),
    ...
    #('Part Number - TAN(4-byte)',      ('0x87', 'TAN_NUM')),
    #('Part Number - TAN(5-byte)',      ('0xDF', 'TAN_NUM')),
    ...
    #('ECI number - Number',            ('0x8E', 'ECI_CODE_NUMBER')),
    ...
    ('part number - USB',              ('0xE6', 'USB_ASSEMBLY_NUM', 'USB DB')),
    ('rev number - USB',               ('0xE6', 'USB_REVISION_NUM', 'USB DB')),
    ('serial number - USB',            ('0xE6', 'USB_SERIAL_NUM', 'USB DB')),
    ('part number - StackPower',       ('0xE6', 'STKPWR_ASSEMBLY_NUM', 'StackPower DB')),
    ('rev number - StackPower',        ('0xE6', 'STKPWR_REVISION_NUM', 'StackPower DB')),
    ('serial number - StackPower',     ('0xE6', 'STKPWR_SERIAL_NUM', 'StackPower DB')),
