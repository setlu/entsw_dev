"""
Catalyst Series 3 Peripherals

[Catalyst]---->[Catalyst3]---->[C_PERIPH]
                                  ^
                                  |
...
# Product Specific
# ----------------
from ..common.catalyst3 import _Catalyst3
from ..common.stardust3 import _Stardust3
from ..common import modes3 as _modes3
from ..common import _common_def
from .product_definitions import _product_line_def

__title__ = "Catalyst Series 3 Peripheral Module"
__version__ = '2.0.0'
__author__ = ['bborel']
...
class Cat3Peripherals(_Catalyst3):
    def __init__(self):
        ...
        self.diags = _Stardust3(mode_mgr=self.mode_mgr, ud=self.ud, linux=self.linux, equip=None)
        self.peripheral = _PeripheralC3K(mode_mgr=self.mode_mgr, sysinit=self.diags.sysinit)
