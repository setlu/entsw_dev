"""
PRODUCT DEFINITIONS for C5K Adelphi
...
__title__ = "C5K Adelphi Product Definitions"
__version__ = '0.0.1'
__author__ = ['qingywu']
__family__ = 'adelphi'
...
family = {
    'COMMON': {
        'product_family': 'adelphi',

        # Product Generation: 'GEN1', 'GEN2', 'GEN3'
        'product_generation': 'GEN3',

        # Product Variant: usually not used
        'product_variant': 'C9500',
        ...
        'pcamap_to_tst_keymap': {'pid': 'uut_type', 'vid': 'version_id', 'sn': 'serial_number', 'hwv': 'tan_hw_rev',
                                 'vpn': 'tan', 'eci': 'eci'},
        'psu_to_tst_keymap': {'CFG_MODEL_NUM': 'uut_type', 'MOTHERBOARD_SERIAL_NUM': 'serial_number', 'TAN': 'tan',
                              'TAN_REVISION_NUMBER': 'tan_hw_rev', 'VERSION_ID': 'version_id',
                              'CLEI_CODE_NUMBER': 'clei', 'ECI_CODE_NUMBER': 'eci'},
        'device_instances_for_tst': ['1', '2'],
    ...
    'ADELPHI16': {
        ...
        'eco_manifest': {('73-18709-01A0', 'ALL'): ('EA557099', '96749', ['PCBDL', 'PCBST', 'PCB2C'], ''),
                         ('68-100903-02A0', 'ALL'): ('EA557099', '96777', ['ASSY', 'SYSBI', 'PCBFT'], ''),
                         ('68-100903-02A0', 'ALL'): (None, 'whatever', ['SYSFT'], ''),
                         }
    },
