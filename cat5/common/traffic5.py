...
__title__ = "Traffic Catalyst Series 5 Module"
__version__ = '2.0.0'
__author__ = ['bborel']
...
# Traffic w/ Diags
# ======================================================================================================================
class _TrafficDiags5(_TrafficDiags):
    def __init__(self, mode_mgr, ud, **kwargs):
        super(_TrafficDiags5, self).__init__(mode_mgr, ud, **kwargs)
        return
...
class TrafficDiagsC9500(_TrafficDiags5):
    def __init__(self, mode_mgr, ud, **kwargs):
        super(TrafficDiagsC9500, self).__init__(mode_mgr, ud, **kwargs)
        return
...
# ======================================================================================================================
class _TrafficSNT5(_TrafficSNT):
    def __init__(self, mode_mgr, ud, **kwargs):
        super(_TrafficSNT5, self).__init__(mode_mgr, ud, **kwargs)
        return
...
class TrafficSNTC9500(_TrafficSNT5):
    def __init__(self, mode_mgr, ud, **kwargs):
        super(TrafficSNTC9500, self).__init__(mode_mgr, ud, **kwargs)
        return
