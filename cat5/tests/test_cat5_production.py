"""
=========================================================
CATALYST Series5 CITP Unittests for Production Simulation
=========================================================
...
__title__ = 'CATALYST Series5 Production Simulation Unit Tests'
__author__ = ['bborel']
__version__ = '2.0.0'
...
class TestC9400ProductionSim(CITPUnittestFramework):
    ...
    def test_prod_sim_run_c9500_pcbp2(self, tss, uuts):
        self.run_multi_container('C9500', 'PCBP2', tss=tss, uuts=uuts)
