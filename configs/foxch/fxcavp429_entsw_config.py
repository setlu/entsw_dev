...
def uabu_c3k_config():
    ...
    station_lookup = {'Station_A_01': {'ip': '10.1.1.3', 'ts': 2003, 'uut_count': 16},
                      'Station_A_02': {'ip': '10.1.1.3', 'ts': 2019, 'uut_count': 16},
                      'Station_A_03': {'ip': '10.1.1.4', 'ts': 2003, 'uut_count': 16},
                      'Station_A_04': {'ip': '10.1.1.4', 'ts': 2019, 'uut_count': 16},
                      'Station_A_05': {'ip': '10.1.1.5', 'ts': 2003, 'uut_count': 16},
                      'Station_A_06': {'ip': '10.1.1.5', 'ts': 2019, 'uut_count': 16},
                      }
